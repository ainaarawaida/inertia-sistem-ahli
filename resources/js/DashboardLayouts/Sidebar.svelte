                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="home" /><span>Dashboard</span></a
                        >
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="airplay" /><span>Widgets</span></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="layout" /><span>Page layout</span
                            ></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="box" /><span>Ui Kits</span></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="edit-3" /><span>Builders</span></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="command" /><span>Icons</span></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="cloud" /><span>Buttons</span></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="bar-chart" /><span>Charts</span
                            ></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="layout" /><span>Form layout</span
                            ></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content">
                            ...
                            <li>
                                <a href="datatable-ext-basic-button.html"
                                    >Basic Button</a
                                >
                            </li>
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="box" /><span>Project </span></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="mail" /><span>Email</span></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="message-circle" /><span>Chat</span
                            ></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="users" /><span>Users</span></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        <a
                            class="nav-link menu-title link-nav"
                            href="bookmark.html"
                            ><i data-feather="heart" /><span>Bookmarks</span></a
                        >
                    </li>
                    <li class="dropdown">
                        <a
                            class="nav-link menu-title link-nav"
                            href="contacts.html"
                            ><i data-feather="list" /><span>Contacts</span></a
                        >
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title link-nav" href="task.html"
                            ><i data-feather="check-square" /><span>Tasks</span
                            ></a
                        >
                    </li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        <a
                            ...
                            ><i data-feather="zap" /><span>Social App</span></a
                        >
                    </li>
                    <li class="dropdown">
                        <a
                            class="nav-link menu-title link-nav"
                            href="to-do.html"
                            ><i data-feather="clock" /><span>To-Do</span></a
                        >
                    </li>
                    <li class="dropdown">
                        <a
                    ...
                    <li>
                        <a
                            ...
                            ><i data-feather="file" /><span>Sample page</span
                            ></a
                        >
                    </li>
                    <li class="dropdown">
                    ...
                    <li class="mega-menu">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="layers" /><span>Others</span></a
                        >
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="image" /><span>Gallery</span></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="edit" /><span>Blog</span></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li>
                        <a class="nav-link menu-title link-nav" href="faq.html"
                            ><i data-feather="help-circle" /><span>FAQ</span></a
                        >
                    </li>
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="layers" /><span>Learning</span></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title" href="javascript:void(0)"
                            ><i data-feather="map" /><span>Maps</span></a
                        >
                        <ul class="nav-submenu menu-content">
                            <li>
